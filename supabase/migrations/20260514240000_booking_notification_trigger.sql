-- Trigger: after any booking status change, append to booking_audit_log and
-- emit notifications for the two key transitions:
--   suggested  → soft_booked : notify assigned producers (fallback: admins)
--   soft_booked → confirmed  : notify the artist
