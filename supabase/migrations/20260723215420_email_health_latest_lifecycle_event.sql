-- Use the newest lifecycle timestamp when selecting the health window. A
-- complaint, bounce, or delay can arrive long after delivery; COALESCE would
-- select the older delivery and omit the fresh incident.
