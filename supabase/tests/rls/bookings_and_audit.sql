...
VALUES
  ('aaaaaaaa-aaaa-0001-0000-000000000000', 'rls-bk-admin@test.com',    '{"provider":"email"}'::jsonb, '{}'::jsonb, now(), now()),
  ('aaaaaaaa-aaaa-0002-0000-000000000000', 'rls-bk-producer@test.com', '{"provider":"email"}'::jsonb, '{}'::jsonb, now(), now()),
  ('aaaaaaaa-aaaa-0003-0000-000000000000', 'rls-bk-artista@test.com',  '{"provider":"email"}'::jsonb, '{}'::jsonb, now(), now()),
  ('aaaaaaaa-aaaa-0004-0000-000000000000', 'rls-bk-artistb@test.com',  '{"provider":"email"}'::jsonb, '{}'::jsonb, now(), now());
...
VALUES ('cccccccc-cccc-0001-0000-000000000000', 'RLS Test Show', 'theatre', 'musical');
