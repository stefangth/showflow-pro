-- Tests for public.resolve_show_assignments(p_program, p_sub_program, p_city_id)
-- (defined in 20260514220000_show_assignments.sql)
--
-- Signature: resolve_show_assignments(TEXT p_program, TEXT p_sub_program, UUID p_city_id)
