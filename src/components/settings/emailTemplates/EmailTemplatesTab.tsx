          ...
          {GROUPS.map((group) => {
            ...
            return templates.length > 0 ? (
              <section
                ...
                className="overflow-hidden rounded-card border border-border bg-card text-foreground"
              >
        ...
        <DialogContent className="max-w-3xl">
          ...
          {preview.loading ? (
            ...
            <iframe
              ...
              className="h-[520px] w-full rounded-card border border-border bg-background"
            />
          )}
        </DialogContent>
      </Dialog>
