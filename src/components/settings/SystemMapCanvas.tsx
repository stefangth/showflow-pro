...
export function SystemMapCanvas() {
  ...
  // Close a stale detail panel when its node is filtered out of view. Guarded
      ...
      <div className="flex gap-4">
                      ...
                      <div key={sg.group ?? `ungrouped-${idx}`} className="flex flex-col gap-2">
                        ...
                        {sg.nodes.map((node) => (
                          <button
                            ...
                            className={cn(
                              "rounded-control border border-border border-l-4 bg-card px-3 py-2 text-left text-sm shadow-sm",
        ...
        {selectedNode ? (
          <aside
            ...
            className="w-72 shrink-0 rounded-control border border-border bg-card p-4"
          >
            <div className="mb-3 flex items-start justify-between gap-2">
              ...
              <button
                ...
                className={cn(
                  "rounded-field p-1 text-muted-foreground hover:text-foreground",
                  "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2",
                )}
              >
                <X className="h-4 w-4" />
