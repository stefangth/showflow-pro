 ...
 * mounted it (mirrors the now-retired v1 `FlowStep`'s footer-portal pattern), falling
 * back to an inline button when the context is null — e.g. rendered outside
 * `WizardShell`, as in this component's own tests.
 *
