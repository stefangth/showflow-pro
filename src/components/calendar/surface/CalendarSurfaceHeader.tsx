  ...
  return (
    ...
    >
      <div data-testid="calendar-surface-header-left">
        <Eyebrow className={TONE_TEXT[eyebrowTone]}>{eyebrow}</Eyebrow>
        <h1 className="font-display text-display-sm font-semibold tracking-tight text-foreground">{title}</h1>
      </div>
      {(children || cta) && (
