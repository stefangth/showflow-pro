...
export const EMAIL_TEMPLATE_COPY_FIELDS: EmailTemplateCopyFields[] = [
  ...
  { templateKey: "tier-at-risk", label: "Tier at risk", fields: [
    field("tier-at-risk.subject", "Subject", ["program", "date"]), field("tier-at-risk.heading", "Heading"), field("tier-at-risk.body", "Body", ["tier", "program", "date", "pending", "accepted", "required"], true), field("tier-at-risk.ctaLabel", "CTA label"), field("tier-at-risk.footer", "Footer", [], true), field("tier-at-risk.previewText", "Preview text", ["program", "date"]), field("tier-at-risk.showFallback", "Show fallback"), field("tier-at-risk.dateFallback", "Date fallback"),
  ] },
  { templateKey: "hire-order-issued", label: "Contract issued", fields: [
  ...
  { templateKey: "hire-order-countersigned", label: "Contract countersigned", fields: [
