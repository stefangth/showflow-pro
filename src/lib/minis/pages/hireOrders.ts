...
const STEP1 = {
  ...
  text: {
    en: '{{ShowDates}} that fill auto-draft one {{hireOrder}}. Every field names where it came from.',
    de: '{{ShowDates}}, die voll werden, entwerfen automatisch einen {{hireOrder}}. Jedes Feld nennt seine Herkunft.',
  },
};
const STEP2 = {
  label: { en: 'Issue and send', de: 'Ausstellen und senden' },
  text: {
    en: 'Issue one {{hireOrder}} or a whole batch. The {{artist}} gets the PDF by email and in the app.',
    de: 'Stelle einen {{hireOrder}} oder einen ganzen Stapel aus. {{Artists}} bekommen das PDF per E-Mail und in der App.',
  },
};
const STEP3 = {
  ...
  text: {
    ...
    de: 'Markiere ihn von Hand als gegengezeichnet, oder {{Artists}} unterschreiben in der App und er springt selbst um.',
  },
};
...
export const hireOrdersMini: MiniDef = {
  ...
  eyebrow: { en: 'How {{hireOrders}} work', de: 'Wie {{hireOrders}} funktionieren' },
  subnote: {
    en: 'Numbering and defaults from Settings · {{HireOrders}}',
    de: 'Nummerierung und Vorgaben aus Einstellungen · {{HireOrders}}',
  },
