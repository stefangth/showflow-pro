...
export const CAPABILITY_DEFS: CapabilityDef[] = [
  ...
  // B. Productions & dates
  { key: "producer_can_manage_productions", action: "manage_productions", role: "producer", group: "Productions & dates", label: "Create and edit productions", description: "Producers can create and edit productions.", risk: "standard", defaultEnabled: true },
  { key: "producer_can_archive_productions", action: "archive_productions", role: "producer", group: "Productions & dates", label: "Archive productions", description: "Producers can archive and unarchive productions.", risk: "standard", defaultEnabled: true },
  { key: "producer_can_reorder_productions", action: "reorder_productions", role: "producer", group: "Productions & dates", label: "Reorder productions", description: "Producers can drag to reorder the production list.", risk: "standard", defaultEnabled: true },
  { key: "producer_can_hard_delete_productions", action: "hard_delete_productions", role: "producer", group: "Productions & dates", label: "Delete productions", description: "Producers can permanently delete productions.", risk: "sensitive", defaultEnabled: false },
  { key: "producer_can_manage_show_dates", action: "manage_show_dates", role: "producer", group: "Productions & dates", label: "Create and edit dates", description: "Producers can create and edit dates.", risk: "standard", defaultEnabled: true },
  { key: "producer_can_hard_delete_show_dates", action: "hard_delete_show_dates", role: "producer", group: "Productions & dates", label: "Delete dates", description: "Producers can permanently delete dates.", risk: "sensitive", defaultEnabled: false },
  // C. Bookings & engine
  ...
  { key: "producer_can_run_offer_engine", action: "run_offer_engine", role: "producer", group: "Bookings & engine", label: "Send and close asks", description: "Producers can send and close asks.", risk: "standard", defaultEnabled: true },
  { key: "producer_can_confirm_bookings", action: "confirm_bookings", role: "producer", group: "Bookings & engine", label: "Confirm bookings", description: "Producers can confirm artists who said yes.", risk: "standard", defaultEnabled: true },
  ...
  // E. Contracts
  { key: "producer_can_generate_hire_orders", action: "generate_hire_orders", role: "producer", group: "Contracts", label: "Generate and draft contracts", description: "Producers can draft contracts.", risk: "standard", defaultEnabled: true, module: "hire_orders" },
  { key: "producer_can_issue_hire_orders", action: "issue_hire_orders", role: "producer", group: "Contracts", label: "Issue contracts", description: "Producers can issue contracts and email the PDF to artists.", risk: "sensitive", defaultEnabled: true, module: "hire_orders" },
  { key: "producer_can_void_hire_orders", action: "void_hire_orders", role: "producer", group: "Contracts", label: "Void contracts", description: "Producers can void issued contracts.", risk: "sensitive", defaultEnabled: true, module: "hire_orders" },
  { key: "producer_can_manage_countersign", action: "manage_countersign", role: "producer", group: "Contracts", label: "Manage countersign", description: "Producers can manage the countersign step.", risk: "standard", defaultEnabled: true, module: "hire_orders" },
  { key: "producer_can_edit_hire_order_settings", action: "edit_hire_order_settings", role: "producer", group: "Contracts", label: "Edit contract settings", description: "Producers can change letterhead, numbering, and terms.", risk: "sensitive", defaultEnabled: false, module: "hire_orders" },
  ...
  { key: "producer_can_manage_skills", action: "manage_skills", role: "producer", group: "Settings & organization", label: "Manage the skills catalog", description: "Producers can create, rename, and archive skills.", risk: "standard", defaultEnabled: true },
